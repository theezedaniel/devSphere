...
function TemplateSelection() {
    ...
    const templatesList = [
        ...
        },
        {
            ...
            icon: <FaDiagramProject className="text-3xl" />
        },
        {
            id: "refactor-story",
            ...
            icon: <FaScrewdriverWrench className="text-3xl" />
        },
        {
            id: "bug-fix-journey",
        ...
        },
        {
            ...
            icon: <FaRegPenToSquare className="text-3xl" />
        }
    ];
                ...
                {templatesList.map((item) => {
                    ...
                    return (
                        <div 
                            ...
                            className={`bg-white rounded-lg space-y-1 hover:shadow-xl hover:-translate-y-1 transition-all duration-300 cursor-pointer shadow 
                                ${isActive ? "ring-2 ring-indigo-300 -translate-y-1 shadow-xl" : ""}`}
                        >
                            <div className={`w-full h-35 flex items-center justify-center rounded-lg bg-gradient-to-br ${item.gradientClass}`}>
                                {item.icon}
                            </div>
