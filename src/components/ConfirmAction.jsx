    ...
    return (
        <div className="flex flex-col gap-8 py-10 px-6 rounded-md w-[500px] m-auto lg:w-[800px] lg:px-20">
            ...
            <div className="flex gap-4">
                ...
                <button 
                className="flex-4 flex gap-2 items-center justify-center capitalize p-3 bg-red-600 text-white rounded  cursor-pointer hover:bg-red-700 transition-all duration-100 lg:text-lg"
                onClick={handleClick}
                disabled={loading}>
