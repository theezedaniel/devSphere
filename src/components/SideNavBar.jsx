...
function SideNavBar({display, toggleSideNav}) {
    ...
    return (
        ...
        `}>
            ...
            <Link to={"/settings"} className="px-3 py-4 flex items-center gap-2 hover:bg-white/30 cursor-pointer rounded lg:text-xl">
            ...
            {user && (
                ...
                <li className="px-3 py-4 flex items-center gap-2 hover:bg-white/30 cursor-pointer rounded lg:text-xl">
